...
-- Recreate workout_logs with all required columns
...
-- Recreate calorie_tracking with all required columns
...
-- Recreate water_tracking with all required columns
...
-- Recreate mental_session_logs with all required columns
